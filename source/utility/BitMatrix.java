...
//
//  Copyright (C) 2007, 2010, 2015, 2021
...
//      New operation 'not'.
//    Version 1.8
//      Checked second argument of 'at' and 'set'.
//    Version 2.3
//      New method 'showByRow'.
//
//=========================================================================
...
public class BitMatrix
{
  ...
  */
  ...
  //--------------------------------------------------------------------
  /**
  *  Writes this matrix in 0-1 form to <code>System.out</code>.
  */
  public void show()
    {
      for (int i=0;i<n;i++)
  ...
  //--------------------------------------------------------------------
  /**
  *  Writes nonempty rows of this matrix as BitSets
