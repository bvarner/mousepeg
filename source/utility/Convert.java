...
//      Removed \b and \f from conversions.
//      Changed limits for Unicode representation.
//      Removed main.
//      More pragmatic version.
//    Version 1.3
//      Implement new character representation policy.
//
//=========================================================================
...
public class Convert
{
  ...
  */
  public static String toStringLit(String s)
    {
  ...
  //  toPrint
  //-------------------------------------------------------------------
  public static String toPrint(String s)
  /**
  ...
  */
  ...
  //  toComment
  //-------------------------------------------------------------------
  public static String toComment(String s)
  /**
