...
//      Construct Paragraphs from Line_Items supplied by Conflicts.
...
public class GUI_Explorer extends GUI
{
  ...
  //-------------------------------------------------------------------
  private void initialize(Conflict c)
    {
      conflict = c;
      initParagraphs(c);
      ...
      write();
      setTitle("In  " + conflict.expr.toNamed());
    }

  //-------------------------------------------------------------------
  //  Initialize explorer paragraphs for conflict 'c'
  //-------------------------------------------------------------------
  private void initParagraphs(Conflict c)
    {
      para1 = new Paragraph_Explorer(conflict.left());
      para2 = new Paragraph_Explorer(conflict.right());
  ...
  //-------------------------------------------------------------------
  static void display(Conflict c)
    {
      if (instance==null)
        instance = new GUI_Explorer();
