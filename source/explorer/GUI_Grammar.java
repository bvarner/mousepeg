...
//    Version 1.9.2
//      Do not show Expr.SigmaStar under 'All'.
//    Version 2.2
//      Use 'named', 'index', 'Properties' from Dual instead of PEG.
//    Version 2.3
    ...
    void keyPressed(String command)
    {
      switch(command)
      {
        ...
        case "Find":
        {
          ...
          setTitle("Find  " + selectedExpr.toNamed());
          BitSet temp = Relations.refs.column(selectedExpr.index);
          show(temp);
          return;
        }
