...
//
//  Copyright (C) 2009, 2010, 2012, 2013, 2019
...
//      Write ok/failed message to System.out instead of err.
//      Specified invocation in comment to the class.
//      Added general catch for all exceptions.
//      Changed structure to the same as TestParser.
//    Version 1.3
//      Removed general catch. Added catch for exceptions that can
//      indicate user error. Declared other exceptions.
//      Removed undocumented possibility to comment out files
//      from file list supplied with '-F'.
//    Version 1.5.1
//      (Steve Owens) Removed unused import.
//    Version 1.6
//      Restructured the code to make TryParser class static.
...
//      Added option '-t'.
//    Version 1.6.1
//      Class TryParser made public.
//    Version 2.0
//      Replaced deprecated method Class.newInstance()
//      by Class.getDeclaredConstructor().newInstance()
//
//=========================================================================
